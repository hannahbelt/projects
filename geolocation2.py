...
def write_output_sentence(geolocator):
    # print(geolocator)
    print(f'My favorite place is my own home. My address is {geolocator["clean_address"][:-5]}, at latitude {geolocator["latitude"]} and longitude {geolocator["longitude"]}, in {geolocator["county"]}, {geolocator["state_long"]}, {geolocator["country"]}.')
...
if __name__ == '__main__':
    address = '4 Ore Mill Pl., Thurmont, MD'
    # address = '4 Ore Mill Pl., Thurmont, MD'
    geolocate(address)